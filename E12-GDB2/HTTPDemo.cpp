...
/*
	How to use this example:
		...
		2. Connect to the ESP8266_VisualGDB_RTOS WiFi network from your computer
		3. Open http://192.168.123.1/test in your browser
*/
...
void RAMFUNC user_init(void)
{
	...
	strcpy((char *)cfg.ssid, "ESP8266_VisualGDB_RTOS");
